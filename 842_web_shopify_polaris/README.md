...
**Shopify Polaris**는 웹 애플리케이션 개발을 위한 프로덕션 준비 완료 템플릿입니다.
...
- [Stack Overflow](https://stackoverflow.com/questions/tagged/shopify polaris)
- [Reddit](https://reddit.com/r/shopify polaris)
