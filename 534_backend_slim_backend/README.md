...
**Slim Backend**는 백엔드 서버 개발을 위한 프로덕션 준비 완료 템플릿입니다.
...
- [Stack Overflow](https://stackoverflow.com/questions/tagged/slim backend)
- [Reddit](https://reddit.com/r/slim backend)
