...
**Mobx State Tree**는 프론트엔드 개발을 위한 프로덕션 준비 완료 템플릿입니다.
...
- [Stack Overflow](https://stackoverflow.com/questions/tagged/mobx state tree)
- [Reddit](https://reddit.com/r/mobx state tree)
