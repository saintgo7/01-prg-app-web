...
**Aws Dynamodb**는 클라우드 서비스 개발을 위한 프로덕션 준비 완료 템플릿입니다.
...
- [Stack Overflow](https://stackoverflow.com/questions/tagged/aws dynamodb)
- [Reddit](https://reddit.com/r/aws dynamodb)
